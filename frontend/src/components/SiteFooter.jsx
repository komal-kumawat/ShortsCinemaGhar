      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '4rem', marginBottom: '4rem' }}>
          <div>
            ...
            <div style={{ marginTop: '1.5rem', fontSize: '0.85rem', color: 'var(--text-dim)', lineHeight: '1.6' }}>
              ...
              <a href="mailto:abhishek@shortfilmtour.in">
                <p style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                  abhishek@shortfilmtour.in
                </p>
              </a>
            </div>
          </div>
        ...
        <div style={{ borderTop: '1px solid var(--border-light)', paddingTop: '2.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '2rem' }}>
          ...
          <div className="flex-center" style={{ gap: '1.5rem' }}>
            <a href="https://www.instagram.com/shortscinemaghar?igsh=MW5hMjU5aGZoZWl5cw==" className="social-link" aria-label="Instagram" style={{ color: 'var(--text-dim)', transition: 'var(--transition-smooth)' }}>
            ...
            <a href="https://youtube.com/@shortscinemaghar?si=9q6lwZt0fhDbtH6F" className="social-link" aria-label="YouTube" style={{ color: 'var(--text-dim)', transition: 'var(--transition-smooth)' }}>
            ...
            <a href="https://www.linkedin.com/company/shorts-cinemaghar/" className="social-link" aria-label="LinkedIn" style={{ color: 'var(--text-dim)', transition: 'var(--transition-smooth)' }}>
